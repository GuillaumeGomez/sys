...
pub const GTK_BUILDER_ERROR_INVALID_ID: GtkBuilderError = GtkBuilderError::InvalidId;
...
pub const GTK_LICENSE_AGPL_3_0: GtkLicense = GtkLicense::Agpl30;
...
pub const GTK_PAD_ACTION_BUTTON: GtkPadActionType = GtkPadActionType::Button;
pub const GTK_PAD_ACTION_RING: GtkPadActionType = GtkPadActionType::Ring;
pub const GTK_PAD_ACTION_STRIP: GtkPadActionType = GtkPadActionType::Strip;
...
pub const GTK_POPOVER_CONSTRAINT_NONE: GtkPopoverConstraint = GtkPopoverConstraint::None;
pub const GTK_POPOVER_CONSTRAINT_WINDOW: GtkPopoverConstraint = GtkPopoverConstraint::Window;
...
pub const GTK_SHORTCUT_ACCELERATOR: GtkShortcutType = GtkShortcutType::Accelerator;
pub const GTK_SHORTCUT_GESTURE_PINCH: GtkShortcutType = GtkShortcutType::GesturePinch;
pub const GTK_SHORTCUT_GESTURE_STRETCH: GtkShortcutType = GtkShortcutType::GestureStretch;
pub const GTK_SHORTCUT_GESTURE_ROTATE_CLOCKWISE: GtkShortcutType = GtkShortcutType::GestureRotateClockwise;
pub const GTK_SHORTCUT_GESTURE_ROTATE_COUNTERCLOCKWISE: GtkShortcutType = GtkShortcutType::GestureRotateCounterclockwise;
pub const GTK_SHORTCUT_GESTURE_TWO_FINGER_SWIPE_LEFT: GtkShortcutType = GtkShortcutType::GestureTwoFingerSwipeLeft;
pub const GTK_SHORTCUT_GESTURE_TWO_FINGER_SWIPE_RIGHT: GtkShortcutType = GtkShortcutType::GestureTwoFingerSwipeRight;
pub const GTK_SHORTCUT_GESTURE: GtkShortcutType = GtkShortcutType::Gesture;
...
pub const GTK_TEXT_VIEW_LAYER_BELOW_TEXT: GtkTextViewLayer = GtkTextViewLayer::BelowText;
pub const GTK_TEXT_VIEW_LAYER_ABOVE_TEXT: GtkTextViewLayer = GtkTextViewLayer::AboveText;
...
bitflags! {
    ...
    pub struct GtkDebugFlag: c_uint {
        ...
        const GTK_DEBUG_RESIZE = 1048576;
        const GTK_DEBUG_LAYOUT = 2097152;
    }
}
...
bitflags! {
    ...
    pub struct GtkInputHints: c_uint {
        ...
        const GTK_INPUT_HINT_VERTICAL_WRITING = 256;
    }
}
...
bitflags! {
    ...
    pub struct GtkStateFlags: c_uint {
        ...
        const GTK_STATE_FLAG_DROP_ACTIVE = 4096;
    }
}
...
bitflags! {
    ...
    pub struct GtkStyleContextPrintFlags: c_uint {
        ...
        const GTK_STYLE_CONTEXT_PRINT_RECURSE = 1;
        const GTK_STYLE_CONTEXT_PRINT_SHOW_STYLE = 2;
    }
}
