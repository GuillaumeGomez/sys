...
pub const G_PARAM_STATIC_STRINGS: c_int = 0;
...
bitflags! {
    #[repr(C)]
    pub struct GBindingFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub struct GConnectFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub struct GSignalFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub struct GSignalMatchType: c_uint {
...
bitflags! {
    #[repr(C)]
    pub struct GTypeDebugFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub struct GTypeFundamentalFlags: c_uint {
