...
pub const ATK_RELATION_DETAILS: AtkRelationType = AtkRelationType::Details;
pub const ATK_RELATION_DETAILS_FOR: AtkRelationType = AtkRelationType::DetailsFor;
pub const ATK_RELATION_ERROR_MESSAGE: AtkRelationType = AtkRelationType::ErrorMessage;
pub const ATK_RELATION_ERROR_FOR: AtkRelationType = AtkRelationType::ErrorFor;
...
pub const ATK_ROLE_FOOTNOTE: AtkRole = AtkRole::Footnote;
...
// Constants
pub const ATK_BINARY_AGE: c_int = 22600;
pub const ATK_INTERFACE_AGE: c_int = 1;
pub const ATK_MAJOR_VERSION: c_int = 2;
pub const ATK_MICRO_VERSION: c_int = 90;
pub const ATK_MINOR_VERSION: c_int = 25;
