...
pub const G_CHECKSUM_SHA384: GChecksumType = GChecksumType::Sha384;
...
pub const G_NUMBER_PARSER_ERROR_INVALID: GNumberParserError = GNumberParserError::Invalid;
pub const G_NUMBER_PARSER_ERROR_OUT_OF_BOUNDS: GNumberParserError = GNumberParserError::OutOfBounds;
...
pub const G_UNICODE_BREAK_EMOJI_BASE: GUnicodeBreakType = GUnicodeBreakType::EmojiBase;
pub const G_UNICODE_BREAK_EMOJI_MODIFIER: GUnicodeBreakType = GUnicodeBreakType::EmojiModifier;
pub const G_UNICODE_BREAK_ZERO_WIDTH_JOINER: GUnicodeBreakType = GUnicodeBreakType::ZeroWidthJoiner;
...
pub const G_UNICODE_SCRIPT_ADLAM: GUnicodeScript = GUnicodeScript::Adlam;
pub const G_UNICODE_SCRIPT_BHAIKSUKI: GUnicodeScript = GUnicodeScript::Bhaiksuki;
pub const G_UNICODE_SCRIPT_MARCHEN: GUnicodeScript = GUnicodeScript::Marchen;
pub const G_UNICODE_SCRIPT_NEWA: GUnicodeScript = GUnicodeScript::Newa;
pub const G_UNICODE_SCRIPT_OSAGE: GUnicodeScript = GUnicodeScript::Osage;
pub const G_UNICODE_SCRIPT_TANGUT: GUnicodeScript = GUnicodeScript::Tangut;
pub const G_UNICODE_SCRIPT_MASARAM_GONDI: GUnicodeScript = GUnicodeScript::MasaramGondi;
pub const G_UNICODE_SCRIPT_NUSHU: GUnicodeScript = GUnicodeScript::Nushu;
pub const G_UNICODE_SCRIPT_SOYOMBO: GUnicodeScript = GUnicodeScript::Soyombo;
pub const G_UNICODE_SCRIPT_ZANABAZAR_SQUARE: GUnicodeScript = GUnicodeScript::ZanabazarSquare;
...
pub struct GHookList {
    pub seq_id: c_ulong,
    #[cfg(any(not(windows), not(target_pointer_width = "64"), feature = "dox"))]
    pub hook_size_and_setup: gpointer,
    #[cfg(any(all(windows, target_pointer_width = "64"), feature = "dox"))]
